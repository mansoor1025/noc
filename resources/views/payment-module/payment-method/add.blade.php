...
<div class="boxed">
    <div id="content-container">
        <div class="pageheader hidden-xs">
            <h3><i class="fa fa-home"></i> Add Payment Method</h3>
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Add Payment Method</h3>
                        </div>
                        <!-- Panel body -->
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('name') }}" class="form-control" name="name" maxlength="30" placeholder="Enter Payment Method Name" required/>
                                            @error('name')
