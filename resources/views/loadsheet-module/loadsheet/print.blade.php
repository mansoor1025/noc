...
<body>
    ...
    <table class="summary" width="100%">
        <tr class="summary" class="summary">
            <th class="summary parcel">#</th>
            <th class="summary parcel">TrackingNo</th>
            <th class="summary parcel">ShipperName</th>
            <th class="summary parcel">UserName</th>
            <th class="summary parcel">City</th>
            <th class="summary parcel">TotalAmount</th>
            <th class="summary parcel">Weight</th>
            <!--<th class="summary parcel">Scan</th>-->
        </tr>
        @foreach ($loadsheet->loadsheet_parcels as $key => $value)
            <tr class="summary">
                <th class="summary parcel">{{ $key + 1 }}</th>
                <th class="summary parcel">{{ $value->parcel->tracking_id }}</th>
                <th class="summary parcel">{{ $loadsheet->customer->company_name }}</th>
                <th class="summary parcel">{{ $value->parcel->user_name }}</th>
                <th class="summary parcel">{{ $value->parcel->destination_city }}</th>
                <th class="summary parcel">{{ $value->parcel->total_amount }}</th>
                <th class="summary parcel">{{ $value->parcel->weight }}</th>
                <!--<th class="summary parcel">{{ $value->scan }}</th>-->
            </tr>
        @endforeach
      </table>
      ...
      <table class="summary" width="100%">
        <tr class="summary">
            <th class="summary" style="padding: 10px"><strong>Rider Signature</strong></th>
            <th class="summary" style="padding: 10px"><strong>Customer Signature</strong></th>
        </tr>
      </table>
